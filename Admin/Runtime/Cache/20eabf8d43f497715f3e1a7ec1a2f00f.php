	...
	<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="__URL__/add"><span>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification attention png_bg">
							...
							<div>
								<?php echo ($article_count); ?> exsiting articles
							</div>
						</div>
								...
								<?php if(is_array($article_list)): foreach($article_list as $key=>$article): ?><tr>
									...
									<td>
										<!-- Icons -->
										 ...
										 <a href="#" title="Edit Meta"><img src="__PUBLIC__/Images/admin/icons/hammer_screwdriver.png" alt="Edit Meta" /></a>
									</td>
